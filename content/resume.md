...
- Built and maintained scalable infrastructure for a leading computer vision startup
- Participated in maintaining SOC2 Type 2 certification
...
- Sole infrastructure engineer at a seed-stage DeFi startup.
- Scaled platform to handle $15B+ USD and 1M+ users.
- Built on GCP (GKE Autopilot, Cloud Run, Memorystore) and AWS (ECS Fargate, Lambda, ElastiCache).
- Focused on serverless technologies to minimize maintenance burden.
- Architected and launched a public API with FastAPI and comprehensive documentation.
- Led SOC 2 Type 2 audit initiative, implementing security and compliance strategies, including Okta integration for federated RBAC in AWS.
- Designed CI/CD pipelines with GitHub Actions and Spacelift, including ephemeral ARM64 runners.
